...
test('set server config', function (t) {
  ...
  const req = { query: { name: 'science', workerToCpuRatio: '1.50', pause: 'true' } };
  const res = {};
  const next = function () {};
...
test('Create a task', function (t) {
  ...
  const req = { body: { name: 'test', command: 'echo hello', trigger: { time: '* * * * *' } } };
  const res = {};
  const next = function () {};
...
test('Show a single task', function (t) {
  ...
  const req = { params: { taskid: 'ummon.test' } };
  const res = {};
  const next = function () {};
...
test('Update a task', function (t) {
  ...
  const req = {
    params: { taskid: 'ummon.test' },
    body: {
      name: 'test', collection: 'ummon', command: 'echo goodbye', trigger: { time: '* * * * *' },
    },
  };
  const res = {};
  const next = function () {};
...
test('Run a task manually', function (t) {
  ...
  const req = { body: { task: 'ummon.test' } };
  const res = {};
  const next = function () {};
...
test('Update a collection', function (t) {
  ...
  const req1 = { body: { name: 'foo.delete-me', command: 'echo hello', trigger: { time: '* * * * *' } } };
  const res = { json() {} };
  const next = function () {};
  api.createTask(req1, res, next);

  // Now create foo.change-me
  const req2 = { body: { name: 'foo.change-me', command: 'echo old-version' } };
...
test('Run a one-off command', function (t) {
  ...
  const req = { body: { task: 'echo hello' } };
  const res = {};
  const next = function () {};
